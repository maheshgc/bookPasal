...
namespace BookPasal.Controllers
{
    ...
    {
        private readonly BikePasalDbContext _context;

        public BikesController(BikePasalDbContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("BikeId,BikeName,BikeNo,ImageName")] Bike bike)
        {
            if (id != bike.BikeId)
            {
                return NotFound();
